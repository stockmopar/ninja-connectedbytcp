			...
			if(self.state){
				...
				if(parsed.on){
					...
					if(self.bri != parsed.bri){
						...
						self.client.TurnOffRoom(self.rid, function(error){self.client.SetRoomLevel(self.rid, level, function(error){});	});
						self.client.SetRoomLevel(self.rid, level, function(error){});
			...
			if(self.state){
				...
				if(parsed.on){
					if(self.bri != parsed.bri){
						...
						self.client.SetDeviceLevel(self.did, level, function(error){});
					...
					if(self.bri != parsed.bri){
						...
						self.client.TurnOffDevice(self.did, function(error){});
						self.client.SetDeviceLevel(self.did, level, function(error){});
				...
				if(parsed.on){
					...
					self.client.SetDeviceLevel(self.did, level, function(error){});
					self.client.TurnOnDevice(self.did, function(error){});
